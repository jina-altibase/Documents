...
- [Altibase 7.1.0.2.6 Patch Notes](#altibase-71026-patch-notes)
  ...
  - [Fixed Bugs](#fixed-bugs)
    ...
    - [BUG-47121  jdbcAdapter conf 파일에 OTHER\_DATABASE\_JDBC\_MAX\_HEAP\_SIZE 가 설정이 되지 않는 문제가 있습니다.](#bug-47121-jdbcadapter-conf-파일에-other_database_jdbc_max_heap_size-가-설정이-되지-않는-문제가-있습니다)
    ...
    - [BUG-47128  Query rebuild시 query\_binding memory가 지속적으로 증가할 수 있습니다.](#bug-47128-query-rebuild시-query_binding-memory가-지속적으로-증가할-수-있습니다)
